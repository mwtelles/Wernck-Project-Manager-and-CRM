        ...
        <div class="col-sm-9 col-lg-10">
            <div class="no-border clearfix ">
                ...
                <ul data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                    <li><a role="presentation" href="javascript:;" data-bs-target="#contract-settings"><?php echo app_lang("contract_settings"); ?></a></li>
                    <li><a role="presentation" href="<?php echo_uri("contract_templates"); ?>" data-bs-target="#contract-templates"><?php echo app_lang("contract_templates"); ?></a></li>
                </ul>

                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade" id="contract-items">
                        ...
                        <div class="p15 b-t mb15">
                                ...
                                <div class="clearfix">
                                    <div class="col-md-12 mt20 pl15 pr15">
                                        ...
                                        foreach ($files as $key => $value) {
                                            ...
                                            echo "<div>";
                                            echo js_anchor(remove_file_prefix($file_name), array("data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("contracts/file_preview/" . $contract_info->id . "/" . $key)));
                                            echo "</div>";
                                        }
                                        ?>
                                    </div>
                            ...
                            <p class="b-t b-info pt10 m15"><?php echo nl2br($contract_info->note); ?></p>
